...
import Howmanyloantakentable from './howmanyloantakentable'
...
export default class Howmanyloantaken extends React.Component{
  ...
  Clicksubmitreq = () =>{
    ...
    render(){
      ...
      const parsed = qs.parse(this.props.location.search);
      var landertableTab = [];
      landertableTab.push(<Howmanyloantakentable values = {parsed}/>);
